// SVG icons — the SkillSafe shield is the same favicon used at
// skillsafe.ai/favicon.svg (also copied to /public/favicon.svg). The Globe is
// a hand-rolled "internet" glyph used wherever we used to render ☁.
...
export function ShieldIcon({ size = 22 }: { size?: number }) {
  return (
    ...
    >
      <defs>
        <linearGradient id="ss-shield" x1="0" y1="0" x2="1" y2="1">
          <stop offset="0%" stopColor="#3d8eff" />
          <stop offset="100%" stopColor="#1a5fd4" />
        </linearGradient>
      </defs>
      <path
        d="M16 2 L28 7 C28 7 29 17.5 23 23 C19.5 27 16 29 16 29 C16 29 12.5 27 9 23 C3 17.5 4 7 4 7 Z"
        fill="url(#ss-shield)"
      />
      <path
        d="M10.5 16 L14 19.8 L22 11.5"
        fill="none"
        stroke="white"
        strokeWidth="2.8"
        strokeLinecap="round"
...
export function UploadCloudIcon({ size = 14 }: { size?: number }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={size} height={size}
      fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
